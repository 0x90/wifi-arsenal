...
#define TDLS_PROHIBIT_CHAN_SWITCH BIT(1)
	...
	// Attack specific SSID
	int specific;

	// Answer broadcast probe requests
	int answer_broadcast_probereq;

	// When answering probe requests, cycle between spoofed RSN values
	int cycle_probe_response_types;

	// Blacklist that prevents attacking given SSIDs
	char *ssid_blacklist;

	// Round robin list
	int cycle_spoof_ssids;
	struct spoof_ssid* spoof_ssid_list[SPOOF_LIST_SIZE];

	// Path to stat database
	char *stat_database_path;
};
