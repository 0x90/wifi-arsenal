...
do
  for i in "wps.enrollee_nonce" "wps.public_key" "wps.registrar_nonce" "wps.authenticator" "wps.encrypted_settings" "wps.r_hash1" "wps.r_hash2" "wps.e_hash1" "wps.e_hash2"
  do
