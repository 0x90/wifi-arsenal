...
:Debug
pushd .
call %DDKPATH%\bin\setenv.bat %DDKPATH% chk WIN7 no_oacr
popd
...
:skipcleanDebug
build
copy /Y objchk_win7_x86\i386\atheeprom.sys ..\Debug\ath32.sys
goto exit 

:Release
pushd .
call %DDKPATH%\bin\setenv.bat %DDKPATH% fre WIN7 no_oacr
popd
...
:skipcleanRelease
build
copy /Y objfre_win7_x86\i386\atheeprom.sys ..\Release\ath32.sys
goto exit 
