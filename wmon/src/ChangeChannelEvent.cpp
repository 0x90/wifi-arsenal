...
ChangeChannelEvent::ChangeChannelEvent(unsigned short channel) : channel(channel) {}

void ChangeChannelEvent::execute(GUI* gui) const {
    gui->updateScanChannel(channel);
}
