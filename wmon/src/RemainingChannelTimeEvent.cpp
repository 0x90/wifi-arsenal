...
RemainingChannelTimeEvent::RemainingChannelTimeEvent(int seconds) : seconds(seconds) {}

void RemainingChannelTimeEvent::execute(GUI* gui) const {
    gui->updateRemainingChannelTime(seconds);
}
