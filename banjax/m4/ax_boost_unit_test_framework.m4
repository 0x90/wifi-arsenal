dnl @synopsis AX_BOOST_UNIT_TEST_FRAMEWORK
dnl
dnl Test for Unit_Test_Framework library from the Boost C++ libraries.
dnl The macro requires a preceding call to AX_BOOST_BASE. Further
